...
<div
    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex gap-2">
            <button @click="handleEdit">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-blue-500 hover:text-blue-700"
                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M15.232 5.232a2.828 2.828 0 114 4L7.5 20.5l-4 1 1-4L15.232 5.232z" />
                </svg>
            </button>
            <button @click="handleDelete">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-red-500 hover:text-red-700" fill="none"
    ...
    <h5 class="mb-2 text-2xl font-semibold break-words text-gray-900 dark:text-white">{{ task.task_title }}</h5>

    <p class="mb-3 font-normal text-gray-500 break-words dark:text-gray-400">{{ task.description }}</p>
